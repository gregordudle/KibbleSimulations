model Coil "Coil"
  ...
  Modelica.Mechanics.Translational.Interfaces.Flange_a pos annotation(
    Placement(transformation(origin = {-100, 58}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {-148, 0}, extent = {{-10, -10}, {10, 10}})));
