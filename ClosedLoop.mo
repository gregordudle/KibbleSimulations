model ClosedLoop
  ...
  Modelica.Blocks.Continuous.LimPID PID( k = 5, yMax = 5, yMin = -5, Ti = 1)  annotation(
...
equation
  ...
  connect(pos_out.flange_b, FIX.flange) annotation(
    Line(points = {{-64, 56}, {-64, 54}, {90, 54}, {90, -76}}, color = {0, 127, 0}));
  ...
  connect(Compensation.flange_b, FIX.flange) annotation(
    Line(points = {{54, 36}, {54, 34}, {90, 34}, {90, -76}}, color = {0, 127, 0}));
  ...
  connect(ForceCurrentConverter.n, GRD.p) annotation(
    Line(points = {{-70, -52}, {-70, -76}}, color = {0, 0, 255}));
