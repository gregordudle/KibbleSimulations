model BIPMcoil "BIPMcoil"
  ...
  constant String fileName = "C:/Users/gregor.dudle/OneDrive - OST/aFE/2024_BIPM_Kibble/Simulations/Modelica_Work/Components/BIPM_MagneticField/BIPM_magnetic_field_02.csv";
  constant String tableName = "Tabelle";
...
equation
 ...
 Documentation(info = "<html><head></head><body>Description of the BIPM coil.&nbsp;<div>Dugr, 2025-09-01<br><div><br><div><br></div></div></div></body></html>", revisions = "<html><head></head><body>2.0</body></html>", __OpenModelica_infoHeader = "<html><head></head><body><br></body></html>"));
end BIPMcoil;
