...
equation
  ...
  connect(coil01.pos, FIX.flange) annotation(
    Line(points = {{-14, 10}, {-60, 10}, {-60, -86}, {0, -86}}, color = {0, 127, 0}));
  connect(LoadCell.flange_b, FIX.flange) annotation(
    Line(points = {{50, 10}, {60, 10}, {60, -86}, {0, -86}}, color = {0, 127, 0}));
  connect(coil01.pos_out, LoadCell.flange_a) annotation(
    Line(points = {{16, 10}, {30, 10}}, color = {0, 127, 0}));
  annotation(
