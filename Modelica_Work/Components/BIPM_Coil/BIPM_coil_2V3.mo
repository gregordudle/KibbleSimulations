model BIPMcoil "BIPMcoil"
  ...
  parameter Real B_l = 458;     // B_l value, can be overwritten from outside
  
  parameter String tableFileName = "BIPM_magnetic_field_02.csv"; // default value. Can be overwritten from outside
...
equation
    ...
    p.i + n.i = 0;
    pos_a.f + pos_b.f = 0;
    pos_a.f = p.i * magneticFieldTable.y * B_l;
    annotation(
 ...
 Documentation(info = "<html><head></head><body>Description of the BIPM coil.&nbsp;<div>B_l can be set for static phase</div><div>Dugr, 2026-09-21<br><div><br><div><br></div></div></div></body></html>", revisions = "<html><head></head><body>3</body></html>", __OpenModelica_infoHeader = "<html><head></head><body><br></body></html>"));
end BIPMcoil;
